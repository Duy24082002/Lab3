          ...
          <div className="Menu">
            <div className="firstbox">
              <div className="aboutme">
                <h2>About me</h2>
                <span>I have passion in IT and I want to become a professional developer.I enjoy playing volleyball sports.</span>
              </div>
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTW2Avd-RVcYnbQqZ4JClBgMF6quKny8zqhuQ&usqp=CAU" alt="" />
              <div className="details">
                <h2>Details</h2>
                <span className="title">Name:</span>
                <span> Tran Duc Duy</span>
